...
//  exception 여부와 상관 없이 메소드 실행 후 호출	
...
//	}
	...
	public void aroundLog(ProceedingJoinPoint pjp) {
		...
		System.out.println("[공통로그] 비즈니스 로직 수행 시 후 호출");
	}
}
